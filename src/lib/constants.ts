...
export const PROJECTS: Project[] = [
  { name: "East Olive Apartments", location: "WA, USA", category: "Residential", image: img("/images/projects/east-olive-apartments.jpg") },
  { name: "Janak Mistry Bungalow", location: "Surat, Gujarat, India", category: "Residential", image: img("/images/projects/janak-mistry-bungalow.jpg") },
  { name: "Milan Dalal Residence", location: "Ahmedabad, Gujarat, India", category: "Residential" },
  { name: "Amantra Bungalow", location: "Surat, Gujarat, India", category: "Residential", image: img("/images/projects/amantra-bungalow.jpg") },
  ...
  { name: "Salmonberry Apartments", location: "WA, USA", category: "Residential", image: img("/images/projects/salmonberry-apartments.jpg") },
  { name: "500 Square Apartments", location: "Bellingham", category: "Residential" },
  { name: "18th Avenue Apartments", location: "Seattle, WA, USA", category: "Residential", image: img("/images/projects/18th-avenue-apartments.jpg") },
  { name: "Union Residency", location: "Surat, Gujarat, India", category: "Residential", image: img("/images/projects/union-residency.jpg") },
  { name: "Milan Dalal Bungalow", location: "Ahmedabad, Gujarat, India", category: "Residential", image: img("/images/projects/milan-dalal-bungalow.jpg") },
  { name: "Edmonds Apartments", location: "", category: "Residential", image: img("/images/projects/edmonds-apartments.jpg") },
  { name: "Sola on Harvard", location: "Seattle, WA, USA", category: "Residential", image: img("/images/projects/sola-on-harvard.webp") },
  { name: "Riviera Flories-Skycity", location: "Ahmedabad, Gujarat, India", category: "Residential", image: img("/images/projects/riviera-flories-skycity.jpg") },
  { name: "Aquatica", location: "Surat, Gujarat, India", category: "Residential", image: img("/images/projects/aquatica.jpg") },
  { name: "Shree Tirupati Balaji Township", location: "Unn, Gujarat, India", category: "Residential", image: img("/images/projects/shree-tirupati-balaji-township.jpg") },
  { name: "Satyamev Luxor", location: "Ahmedabad, Gujarat, India", category: "Residential", image: img("/images/projects/satyamev-luxor.jpg") },
  { name: "La Marque", location: "Ahmedabad, Gujarat, India", category: "Residential", image: img("/images/projects/la-marque.jpg") },
  { name: "Rivanta", location: "Gandhinagar, Gujarat, India", category: "Residential", image: img("/images/projects/rivanta.jpg") },
  { name: "Gala Bellissimo", location: "Ahmedabad, Gujarat, India", category: "Residential", image: img("/images/projects/gala-bellissimo.png") },
  { name: "The Signature", location: "GIFT City, Gandhinagar, Gujarat", category: "Residential", image: img("/images/projects/the-signature.jpg") },
  { name: "World Trade Center", location: "GIFT City, Gandhinagar, Gujarat, India", category: "Residential", image: img("/images/projects/world-trade-center.jpg") },
  { name: "Staybridge Suites", location: "WA, USA", category: "Commercial" },
  { name: "Marriott Courtyard", location: "WA, USA", category: "Commercial", image: img("/images/projects/marriott-courtyard.jpg") },
  ...
  { name: "Na Mu Lodge", location: "Leavenworth, WA, USA", category: "Commercial", image: img("/images/projects/na-mu-lodge.jpg") },
  ...
  { name: "FK House", location: "Bellevue, WA, USA", category: "Commercial", image: img("/images/projects/fk-house.jpg") },
  { name: "The Brigade", location: "GIFT City, Gandhinagar, Gujarat, India", category: "Commercial", image: img("/images/projects/the-brigade.jpg") },
  { name: "Capital 2", location: "", category: "Commercial", image: img("/images/projects/capital-2.jpg") },
  { name: "Seatec Hilton Garden Inn", location: "WA, USA", category: "Commercial", image: img("/images/projects/seatec-hilton-garden-inn.jpg") },
  { name: "GEPIL", location: "Haryana, India", category: "Industrial", image: img("/images/projects/gepil.jpg") },
  { name: "Single Storey Retail Building", location: "USA", category: "Industrial" },
  { name: "Project SCMA", location: "", category: "Industrial" },
  { name: "Aroma Biotech", location: "Vijaywada, Andhra Pradesh, India", category: "Industrial", image: img("/images/projects/aroma-biotech.jpg") },
  { name: "Ben E. Keith", location: "Houston, TX, USA", category: "Industrial", image: img("/images/projects/ben-e-keith.jpg") },
  { name: "Newcold Tacoma", location: "", category: "Industrial", image: img("/images/projects/newcold-tacoma.jpg") },
  { name: "400 108th Avenue NE Bellevue", location: "Seismic and Condition Study", category: "Industrial" },
  { name: "Darigold Sunnyside", location: "", category: "Industrial", image: img("/images/projects/darigold-sunnyside.jpg") },
  ...
  { name: "Chincholi Sugar", location: "India", category: "Industrial", image: img("/images/projects/chincholi-sugar.jpg") },
  { name: "Amway Extraction Concentration Facility", location: "", category: "Industrial", image: img("/images/projects/amway-extraction-concentration.jpg") },
  ...
  { name: "Pipe Rack: Chemical Plant", location: "Dahej, Gujarat, India", category: "Industrial", image: img("/images/projects/pipe-rack-chemical-plant.jpg") },
  { name: "Yash Specialty Chemicals LLP", location: "Dahej, Gujarat, India", category: "Industrial", image: img("/images/projects/yash-specialty-chemicals.jpeg") },
  { name: "Rallis India Ltd. — Warehouse Expansion", location: "Gujarat, India", category: "Industrial", image: img("/images/projects/rallis-india-warehouse-expansion.jpg") },
  { name: "Bluetex Industries Pvt. Ltd Unit (I)", location: "Panoli, Gujarat, India", category: "Industrial", image: img("/images/projects/bluetex-industries-unit-1.jpg") },
  { name: "Aarti Industries Limited — Neo to Saffron Plant", location: "Dahej, Gujarat, India", category: "Industrial", image: img("/images/projects/aarti-neo-saffron-plant.jpg") },
  { name: "GEPIL Admin Office", location: "Haryana, India", category: "Industrial", image: img("/images/projects/gepil-admin-office.jpg") },
  ...
  { name: "Kadlec West Clearwater MOB", location: "", category: "Healthcare", image: img("/images/projects/kadlec-west-clearwater-mob.jpg") },
  { name: "Lower Columbia Pathology Lab", location: "USA", category: "Healthcare", image: img("/images/projects/lower-columbia-pathology-lab.jpg") },
  ...
  { name: "HP Loyola Centre", location: "", category: "Educational", image: img("/images/projects/hp-loyola-centre.jpg") },
  { name: "Three Seattle Schools — Reroof and Seismic", location: "", category: "Educational" },
  { name: "Community Hall", location: "Sirohi, India", category: "Special Structures", image: img("/images/projects/community-hall.jpg") },
...
export const FEATURED_PROJECTS = [
  { name: "Newcold Tacoma", image: img("/images/projects/newcold-tacoma.jpg") },
  { name: "Amantra Bungalow", image: img("/images/projects/amantra-bungalow.jpg") },
  { name: "Marriott Courtyard", image: img("/images/projects/marriott-courtyard.jpg") },
  { name: "Aquatica", image: img("/images/projects/aquatica.jpg") },
  { name: "Union Residency", image: img("/images/projects/union-residency.jpg") },
]
